        ...
        <div className="py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400 leading-relaxed">
              ...
              in a seamless real estate experience.
            </p>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Link to="/agents" className="block text-gray-400 hover:text-white transition-colors">
                Find Agents
              </Link>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <Link to="/auth/signup" className="block text-gray-400 hover:text-white transition-colors">
                Join as Agent
              </Link>
              <Link to="/pricing" className="block text-gray-400 hover:text-white transition-colors">
                Pricing Plans
              </Link>
              <Link to="/agent-resources" className="block text-gray-400 hover:text-white transition-colors">
                Agent Resources
              </Link>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-400">info@propfinder.com</span>
              </div>
            </div>
          </div>
        </div>
