import { Check, Crown, Loader, Star, Zap } from "lucide-react";
...
const Plans: React.FC = () => {
  ...
  const [loading, setLoading] = useState<string | null>(null); // Plan ID que está siendo procesado
  ...
  const handlePlanSelection = async (planName: string, price: number) => {
    ...
    try {
      ...
      const paymentMethod = await new Promise<"stripe" | "paypal" | null>(
        (resolve) => {
          ...
          <div class="bg-white p-6 rounded-lg max-w-md w-full mx-4">
            ...
            <p class="text-gray-600 mb-6">Plan: ${planName} - $${price}</p>
            <div class="space-y-3">
              <button id="stripe-btn" class="w-full p-3 border border-gray-300 rounded-lg hover:bg-gray-50 flex items-center justify-center">
                <svg class="h-6 w-6 mr-2 text-purple-600" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M13.976 9.15c-2.172-.806-3.356-1.426-3.356-2.409 0-.831.683-1.305 1.901-1.305 2.227 0 4.515.858 6.09 1.631l.89-5.494C18.252.975 15.697 0 12.165 0 9.667 0 7.589.654 6.104 1.872 4.56 3.147 3.757 4.992 3.757 7.218c0 4.039 2.467 5.76 6.476 7.219 2.585.92 3.445 1.574 3.445 2.583 0 .98-.84 1.545-2.354 1.545-1.875 0-4.965-.921-6.99-2.109l-.9 5.555C5.175 22.99 8.385 24 11.714 24c2.641 0 4.843-.624 6.328-1.813 1.664-1.305 2.525-3.236 2.525-5.732 0-4.128-2.524-5.851-6.594-7.305h.003z"/>
                </svg>
                Pagar con Stripe (Tarjeta)
              </button>
              <button id="paypal-btn" class="w-full p-3 border border-gray-300 rounded-lg hover:bg-gray-50 flex items-center justify-center">
                <svg class="h-6 w-6 mr-2 text-blue-600" viewBox="0 0 24 24" fill="currentColor">
      ...
      console.log(
        `Creando pago con ${paymentMethod} para plan: ${planName} - $${price}`
      );
      ...
      const paymentData = {
        ...
        amount: price,
        currency: "USD",
        description: `Plan ${planName} - PropFinder`,
      ...
      if (paymentMethod === "stripe") {
        // Para Stripe, necesitamos usar Stripe Elements
        alert(
          `Pago con Stripe creado. Client Secret: ${paymentResult.clientSecret}\n\nEn un entorno real, aquí se integraría Stripe Elements para completar el pago.`
        );
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Elige el plan perfecto para tu negocio inmobiliario. Todos los
            planes incluyen acceso completo a la plataforma.
          </p>
        </div>
            ...
            >
              ...
              <div className={`p-6 ${plan.popular ? "pt-12" : ""}`}>
                ...
                <button
                  ...
                  className={`w-full py-3 rounded-lg font-semibold transition-colors flex items-center justify-center ${plan.buttonStyle}`}
        ...
        <div className="bg-white rounded-lg shadow-md p-8">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-gray-600">
                Todos los planes pagos incluyen 14 días de prueba gratis. No se
            ...
            <div>
              ...
              <p className="text-gray-600">
                Puedes cancelar en cualquier momento. Tu cuenta se mantendrá
                activa hasta el final del período de facturación actual.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-600">
                Sí, ofrecemos 20% de descuento en todos los planes pagos cuando
                eliges facturación anual.
              </p>
            </div>
          </div>
        </div>
